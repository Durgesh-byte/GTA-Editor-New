...
#include "../../libmaia-master_modified/maiaFault.h"
...
const QMetaObjectExtraData MaiaFault::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MaiaFault::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MaiaFault,
      qt_meta_data_MaiaFault, &staticMetaObjectExtraData }
};
