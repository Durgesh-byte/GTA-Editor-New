//GTAActionParentTitleEnd.h

#ifndef GTAACTIONPARENTTITLEEND_H
#define GTAACTIONPARENTTITLEEND_H
#include <GTAActionBase.h>
class GTACommands_SHARED_EXPORT GTAActionParentTitleEnd : public GTAActionBase
{
public:
    GTAActionParentTitleEnd();
    virtual ~GTAActionParentTitleEnd();
    GTAActionParentTitleEnd(const GTAActionParentTitleEnd& rhs);
    ...
    */
    ...
    bool hasPrecision() const{return false;}
     ...
     bool canHaveInstanceName(){return false;}

private:

};

#endif // GTAActionParentTitleEnd_H
