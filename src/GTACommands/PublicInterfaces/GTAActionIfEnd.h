...
#ifndef GTAACTIONIFEND_H
#define GTAACTIONIFEND_H
#include <GTAActionBase.h>
class GTACommands_SHARED_EXPORT GTAActionIfEnd : public GTAActionBase
{
public:
	GTAActionIfEnd();
	virtual ~GTAActionIfEnd();
	GTAActionIfEnd(const GTAActionIfEnd& rhs);
