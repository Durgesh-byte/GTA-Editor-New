#ifndef GTAEQUATIONSAWTOOTH_H
#define GTAEQUATIONSAWTOOTH_H
...
class GTACommands_SHARED_EXPORT GTAEquationSawTooth : public GTAEquationBase
{

public:
    //enum rampMode{INVERTED,RAMPUP};
    GTAEquationSawTooth();
    virtual ~GTAEquationSawTooth();
    GTAEquationSawTooth(const GTAEquationSawTooth& rhs);
    ...
    void setRampMode(const QString &iVal);
