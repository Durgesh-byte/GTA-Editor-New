//GTAActionDoWhileEnd.h

#ifndef GTAACTIONDOWHILEEND_H
#define GTAACTIONDOWHILEEND_H
#include <GTAActionBase.h>
class GTACommands_SHARED_EXPORT GTAActionDoWhileEnd : public GTAActionBase
{
public:
    GTAActionDoWhileEnd();
    virtual ~GTAActionDoWhileEnd();
    GTAActionDoWhileEnd(const GTAActionDoWhileEnd& rhs);
