...
void GTACommandBase::getNumberOfOK(int& NumberOfOK, GTACommandBase* pCmd)
{
    if (pCmd != NULL)
    {
        ...
        {
            GTACommandBase* pChildCommand = NULL;

            foreach(pChildCommand, lstChildren)
            {
                if (!pChildCommand->getExecutionResult().isEmpty() )
                {
                    if (pChildCommand->getExecutionResult() == "OK")
                    {
                        NumberOfOK += 1;
                    }
                    
                    QList<GTACommandBase*> lstChildOfChild = pChildCommand->getChildren();

                    if(!lstChildOfChild.isEmpty())
                    {
                        getNumberOfOK(NumberOfOK, pChildCommand);
                    }
                }
            }
        }
        ...
        {
            if (!pCmd->getExecutionResult().isEmpty() && pCmd->getExecutionResult() == "OK")
            {
                NumberOfOK += 1;
            }
        }
...
void GTACommandBase::getNumberOfKO(int& NumberOfKO, GTACommandBase* pCmd)
{
    if (pCmd != NULL)
    {
        QList<GTACommandBase*> lstChildren = pCmd->getChildren();
        if (!lstChildren.isEmpty())
        {
            ...
            foreach(pChildCommand, lstChildren)
            {
                if (!pChildCommand->getExecutionResult().isEmpty())
                {
                    if (pChildCommand->getExecutionResult() == "KO")
                    {
                        NumberOfKO += 1;
                    }
                    ...
                    if (!lstChildOfChild.isEmpty())
                    {
                        getNumberOfKO(NumberOfKO, pChildCommand);
                    }
                }
            }
        }
        ...
        {
            if (!pCmd->getExecutionResult().isEmpty() && pCmd->getExecutionResult() == "KO")
            {
                NumberOfKO += 1;
            }
        }
...
void GTACommandBase::getNumberOfNA(int& NumberOfNA, GTACommandBase* pCmd)
{
    if (pCmd != NULL)
    {
        QList<GTACommandBase*> lstChildren = pCmd->getChildren();
        if (!lstChildren.isEmpty())
        {
            ...
            foreach(pChildCommand, lstChildren)
            {
                if (!pChildCommand->getExecutionResult().isEmpty())
                {
                    if (pChildCommand->getExecutionResult() == "NA")
                    {
                        NumberOfNA += 1;
                    }
                    ...
                    if (!lstChildOfChild.isEmpty())
                    {
                        getNumberOfNA(NumberOfNA, pChildCommand);
                    }
                }
            }
        }
        ...
        {
            if (!pCmd->getExecutionResult().isEmpty() && pCmd->getExecutionResult() == "NA")
            {
                NumberOfNA += 1;
            }
        }
...
void GTACommandBase::getNumberOfKOWithDefect(int& NumberOfKOWithDefect, GTACommandBase* pCmd)
{
    if (pCmd != NULL)
    {
        QList<GTACommandBase*> lstChildren = pCmd->getChildren();
        if (!lstChildren.isEmpty())
        {
            ...
            foreach(pChildCommand, lstChildren)
            {
                if (!pChildCommand->getExecutionResult().isEmpty())
                {
                    if (pChildCommand->getExecutionResult() == "KO" && pChildCommand->getReferences() != "")
                    {
                        NumberOfKOWithDefect += 1;
                    }
                    ...
                    if (!lstChildOfChild.isEmpty())
                    {
                        getNumberOfKOWithDefect(NumberOfKOWithDefect, pChildCommand);
                    }
                }
            }
        }
...
void GTACommandBase::getListOfDefects(QString &ListOfDefects, GTACommandBase* pCmd)
{
    if (pCmd != NULL)
    {
        QList<GTACommandBase*> lstChildren = pCmd->getChildren();
        if (!lstChildren.isEmpty())
        {
            ...
            foreach(pChildCommand, lstChildren)
            {
                if (!pChildCommand->getExecutionResult().isEmpty())
                {
                    if (pChildCommand->getExecutionResult() == "KO" && pChildCommand->getReferences() != "")
                    {
                        ListOfDefects = ListOfDefects + pChildCommand->getReferences() + ", ";
                    }
                    ...
                    if (!lstChildOfChild.isEmpty())
                    {
                        getListOfDefects(ListOfDefects, pChildCommand);
                    }
                }
            }
        }
...
bool GTACommandBase::searchString([[maybe_unused]] const QRegExp& iRegExp, [[maybe_unused]] bool ibTextSearch) const {
    return false;
}
...
*/
bool GTACommandBase::searchCommentAndRequirements(const QRegExp& iRegExp) const
{
