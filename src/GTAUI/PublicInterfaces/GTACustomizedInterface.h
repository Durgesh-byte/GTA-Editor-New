...
struct AINGTACustomizedInterface
{
    //TODO: first name, second value, change to struct
    using Param = QPair<QString, QString>;
    using Params = QList<Param>;

    AINGTACustomizedInterface();
    AINGTACustomizedInterface(QString name);
...
struct AINGTACustomizedCheck : public  AINGTACustomizedInterface
{
    AINGTACustomizedCheck();
    AINGTACustomizedCheck(const QString& name);
...
struct AINGTACustomizedAction : public  AINGTACustomizedInterface
{
    AINGTACustomizedAction();
    AINGTACustomizedAction(const QString& name, const QString& complement);
